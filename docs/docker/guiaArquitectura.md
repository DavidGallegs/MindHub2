...
7. Optimización de TypeScript (Evitar errores fantasma en WSL):
   ...
   - (Opcional): refrescamos el editor: `F1` -> **Developer: Reload Window**.
...
4. Y creamos tablas de artisan: `php artisan migrate`
5. Salimos del contenedor con `exit`
6. Otorgamos permisos para editar archivos: `sudo chown -R $USER:$USER backend/`
7. Configuramos el fragmento de la base de datos del archivo `.env`
...
4. Nos metemos en la carpeta del proyecto
